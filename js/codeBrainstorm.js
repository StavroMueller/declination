...
var thisDialog = trackRoomScripts["trophy"]

var dialogThing = setInterval(dialogTick, 500);

//I think it's better to set interval than the other thing...hang on.

function dialogTick(talkingTo) {
    //what are the things we want to HAVE in this function?
    // - the first thing to 
    

	var timeToRead = talkingTo.message.split(' ').length * Declination.config.wordsPerSecond;
    
    
}

//we can do it with .delay, for the valye if t
